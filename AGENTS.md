...
3. 审计基线（2026-09-10 12:05 更新）：hq-mobile = `89bec7e1`（test_hq.js 口径回归自测 88 断言全绿+AGENTS.md 纳入流程，2026-09-10 房主拍板"干"后推送）· k-station = `46c04171`（ks-0910-43 七连修，2026-09-10 05:5x 推送）。每次合法推送后更新本行。
